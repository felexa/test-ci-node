...
import ClassifierModule from "desktop/modules/catalog/search/classifier";
...
class Ingredients extends React.Component {
     ...
     */
    getView() {
        return ClassifierModule.getView(
            ClassifierModule.normalizeInitialProps(this.props.initialData, this.props.pageInfo), this.props.pageInfo
        );
    }
 ...
 * @returns {*}
 */
Ingredients.getInitialProps = function (context, props) {
    return ClassifierModule.getServerSideProps(context, props);
};
